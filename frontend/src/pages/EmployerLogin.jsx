...
export default function EmployerLogin() {
  ...
  return (
    <div className="grid-2">
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="text-center mt-4 text-muted">
              New to KaziLive?{" "}
              <Link to="/employer/register" style={{ color: "var(--primary)" }}>
                Register here
              </Link>
            </p>
          </form>
      ...
      <div className="card">
        <div className="card-header">
          <h3>Elevate Your Hiring Experience</h3>
        </div>
        ...
        <div className="card-body">
          <ul className="list-unstyled">
            <li className="py-3 divider-b flex-center-gap">
              ...
              <div>
                <strong>Elite Talent Access</strong>
                <p className="small text-muted">Connect with verified Kenyan professionals.</p>
              </div>
            </li>
            ...
            <li className="py-3 divider-b flex-center-gap">
              ...
              <div>
                <strong>Secure Recruitment</strong>
                <p className="small text-muted">Manage postings and applications safely.</p>
              </div>
            </li>
            ...
            <li className="py-3 flex-center-gap">
              ...
              <div>
                <strong>Seamless Verification</strong>
                <p className="small text-muted">Verify profiles via integrated M-Pesa gateway.</p>
              </div>
            </li>
          </ul>

          <div className="pt-4 border-t mt-4">
            <p className="text-center italic small text-muted">Trusted by 500+ businesses nationwide</p>
          </div>
        </div>
      </div>
    </div>
